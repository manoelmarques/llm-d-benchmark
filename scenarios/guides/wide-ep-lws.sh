...
export LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_INITIAL_DELAY=240
export LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_FAILURE_THRESHOLD=2700
export LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_PATH=/v1/models
export LLMDBENCH_VLLM_COMMON_READINESS_PROBE_PATH=/v1/models
...
export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_STARTUP_PROBE_INITIAL_DELAY=${LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_INITIAL_DELAY}
export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_STARTUP_PROBE_FAILURE_THRESHOLD=${LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_FAILURE_THRESHOLD}
export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_STARTUP_PROBE_PATH=${LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_PATH}
export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_READINESS_PROBE_PATH=${LLMDBENCH_VLLM_COMMON_READINESS_PROBE_PATH}
...
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_STARTUP_PROBE_INITIAL_DELAY=${LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_INITIAL_DELAY}
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_STARTUP_PROBE_FAILURE_THRESHOLD=${LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_FAILURE_THRESHOLD}
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_STARTUP_PROBE_PATH=${LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_PATH}
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_READINESS_PROBE_PATH=${LLMDBENCH_VLLM_COMMON_READINESS_PROBE_PATH}
