...
#  imagePullPolicy: Always
#  command: ["set_llmdbench_environment.py", "-d", "-e", "/shared-config/llmdbench_env.sh", "-i"]
#  volumeMounts:
#  - name: shared-config
#    mountPath: /shared-config
#EOF
...
#export LLMDBENCH_VLLM_STANDALONE_STARTUP_PROBE_PATH=${LLMDBENCH_VLLM_COMMON_STARTUP_PROBE_PATH}
#export LLMDBENCH_VLLM_STANDALONE_READINESS_PROBE_PATH=${LLMDBENCH_VLLM_COMMON_READINESS_PROBE_PATH}
...
export LLMDBENCH_CONTROL_WORK_DIR=~/data/gpu
