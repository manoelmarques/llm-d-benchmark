...
export LLMDBENCH_LLMD_IMAGE_TAG=v0.7.1

export LLMDBENCH_VLLM_COMMON_CPU_NR=2
export LLMDBENCH_VLLM_COMMON_CPU_MEM=4Gi
export LLMDBENCH_VLLM_COMMON_SHM_MEM=2Gi

export LLMDBENCH_HARNESS_CPU_NR=2
export LLMDBENCH_HARNESS_CPU_MEM=8Gi
