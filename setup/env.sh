...
export LLMDBENCH_FMA_CHART_VERSION="${LLMDBENCH_CHART_VERSION:-0.5.1-alpha.4}"
export LLMDBENCH_FMA_IMAGE_REGISTRY="${LLMDBENCH_FMA_IMAGE_REGISTRY:-ghcr.io/llm-d-incubation/llm-d-fast-model-actuation}"
export LLMDBENCH_FMA_IMAGE_TAG="${LLMDBENCH_FMA_IMAGE_TAG:-v0.5.1-alpha.4}"
...
export LLMDBENCH_FMA_REQUESTER_IMAGE_TAG="${LLMDBENCH_FMA_REQUESTER_IMAGE_TAG:-v0.5.1-alpha.4}"
...
export LLMDBENCH_FMA_LAUNCHER_IMAGE_TAG="${LLMDBENCH_FMA_LAUNCHER_IMAGE_TAG:-v0.5.1-alpha.4}"
