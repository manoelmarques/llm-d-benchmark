...
export LLMDBENCH_WVA_IMAGE_REPOSITORY="${LLMDBENCH_WVA_IMAGE_REPOSITORY:-ghcr.io/llm-d-incubation/workload-variant-autoscaler}"
export LLMDBENCH_WVA_IMAGE_TAG="${LLMDBENCH_WVA_IMAGE_TAG:-v0.4.2}"
...
# Fast Model Actuation Switch
export LLMDBENCH_FMA_ENABLED="${LLMDBENCH_FMA_ENABLED:-false}"

# Fast Model Actuation Dual Pod Configuration
export LLMDBENCH_FMA_DUAL_POD_HELM_REPOSITORY_URL=${LLMDBENCH_FMA_DUAL_POD_HELM_REPOSITORY_URL:-"oci://ghcr.io/manoelmarques/llm-d-fast-model-actuation/charts/dual-pods-controller"}
export LLMDBENCH_FMA_DUAL_POD_CHART_VERSION="${LLMDBENCH_FMA_DUAL_POD_CHART_VERSION:-0.1.0}"
export LLMDBENCH_FMA_DUAL_POD_IMAGE_REPOSITORY="${LLMDBENCH_FMA_DUAL_POD_IMAGE_REPOSITORY:-ghcr.io/aavarghese/llm-d-fast-model-actuation/dual-pods-controller}"
#export LLMDBENCH_FMA_DUAL_POD_IMAGE_REPOSITORY="${LLMDBENCH_FMA_DUAL_POD_IMAGE_REPOSITORY:-ghcr.io/llm-d-incubation/llm-d-fast-model-actuation/dual-pods-controller}"
export LLMDBENCH_FMA_DUAL_POD_IMAGE_TAG="${LLMDBENCH_FMA_DUAL_POD_IMAGE_TAG:-latest}"
export LLMDBENCH_FMA_DUAL_POD_CLUSTER_ROLE="${LLMDBENCH_FMA_DUAL_POD_CLUSTER_ROLE:-}"
...
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_HELM_REPOSITORY_URL=${LLMDBENCH_FMA_LAUNCHER_POPULATOR_HELM_REPOSITORY_URL:-"oci://ghcr.io/manoelmarques/llm-d-fast-model-actuation/charts/launcher-populator"}
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_CHART_VERSION="${LLMDBENCH_FMA_LAUNCHER_POPULATOR_CHART_VERSION:-0.1.0}"
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_IMAGE_REPOSITORY="${LLMDBENCH_FMA_LAUNCHER_POPULATOR_IMAGE_REPOSITORY:-ghcr.io/llm-d-incubation/llm-d-fast-model-actuation/launcher-populator}"
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_IMAGE_TAG="${LLMDBENCH_FMA_LAUNCHER_POPULATOR_IMAGE_TAG:-latest}"
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_CLUSTER_ROLE="${LLMDBENCH_FMA_LAUNCHER_POPULATOR_CLUSTER_ROLE:-}"
...
export LLMDBENCH_FMA_REQUESTER_IMAGE_REPOSITORY="${LLMDBENCH_FMA_REQUESTER_IMAGE_REPOSITORY:-ghcr.io/aavarghese/llm-d-fast-model-actuation/requester}"
...
export LLMDBENCH_FMA_REQUESTER_IMAGE_TAG="${LLMDBENCH_FMA_REQUESTER_IMAGE_TAG:-latest}"
