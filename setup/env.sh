...
export LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_TAG=${LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_TAG:-"auto"}
export LLMDBENCH_VLLM_STANDALONE_IMAGE_TAG=${LLMDBENCH_VLLM_STANDALONE_IMAGE_TAG:-"auto"}
export LLMDBENCH_GATEWAY_PROVIDER_KGATEWAY_CHART_VERSION=${LLMDBENCH_GATEWAY_PROVIDER_KGATEWAY_CHART_VERSION:-"v2.2.1"}
export LLMDBENCH_GATEWAY_PROVIDER_KGATEWAY_NAMESPACE=${LLMDBENCH_GATEWAY_PROVIDER_KGATEWAY_NAMESPACE:-"kgateway-system"}
export LLMDBENCH_GATEWAY_PROVIDER_ISTIO_CHART_VERSION=${LLMDBENCH_GATEWAY_PROVIDER_ISTIO_CHART_VERSION:-"1.29.1"}
export LLMDBENCH_GATEWAY_PROVIDER_ISTIO_NAMESPACE=${LLMDBENCH_GATEWAY_PROVIDER_ISTIO_NAMESPACE:-"istio-system"}
export LLMDBENCH_LWS_CHART_VERSION=${LLMDBENCH_LWS_CHART_VERSION:-"0.8.0"}
export LLMDBENCH_LWS_NAMESPACE=${LLMDBENCH_LWS_NAMESPACE:-"lws-system"}
export LLMDBENCH_VLLM_INFRA_CHART_VERSION=${LLMDBENCH_VLLM_INFRA_CHART_VERSION:-"auto"}
export LLMDBENCH_GATEWAY_API_CRD_REVISION=${LLMDBENCH_GATEWAY_API_CRD_REVISION:-"v1.4.0"}
export LLMDBENCH_WVA_CHART_VERSION=${LLMDBENCH_WVA_CHART_VERSION:-"auto"}
export LLMDBENCH_WVA_IMAGE_TAG=${LLMDBENCH_WVA_IMAGE_TAG:-"auto"}
...
export LLMDBENCH_VLLM_GAIE_CHART_VERSION=${LLMDBENCH_VLLM_GAIE_CHART_VERSION:-v1.3.1}
...
export LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_REGISTRY=${LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_REGISTRY:-ghcr.io}
export LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_REPO=${LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_REPO:-llm-d}
export LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_NAME=${LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_NAME:-llm-d-uds-tokenizer}
...
export LLMDBENCH_FMA_HELM_REPOSITORY_URL=${LLMDBENCH_FMA_HELM_REPOSITORY_URL:-"oci://ghcr.io/llm-d-incubation/llm-d-fast-model-actuation/charts/fma-controllers"}
export LLMDBENCH_FMA_CHART_VERSION="${LLMDBENCH_CHART_VERSION:-0.5.1-alpha.5}"
export LLMDBENCH_FMA_IMAGE_REGISTRY="${LLMDBENCH_FMA_IMAGE_REGISTRY:-ghcr.io/llm-d-incubation/llm-d-fast-model-actuation}"
export LLMDBENCH_FMA_IMAGE_TAG="${LLMDBENCH_FMA_IMAGE_TAG:-v0.5.1-alpha.5}"
export LLMDBENCH_FMA_ITERATIONS=="${LLMDBENCH_FMA_ITERATIONS:-1}"

# Fast Model Actuation CRDs
export LLMDBENCH_FMA_INFERENCE_SERVER_CONFIG_CRD_URL=${LLMDBENCH_FMA_INFERENCE_SERVER_CONFIG_CRD_URL:-"https://raw.githubusercontent.com/llm-d-incubation/llm-d-fast-model-actuation/main/config/crd/fma.llm-d.ai_inferenceserverconfigs.yaml"}
export LLMDBENCH_FMA_LAUNCHER_CONFIG_CRD_URL=${LLMDBENCH_FMA_LAUNCHER_CONFIG_CRD_URL:-"https://raw.githubusercontent.com/llm-d-incubation/llm-d-fast-model-actuation/main/config/crd/fma.llm-d.ai_launcherconfigs.yaml"}
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_POLICIES_CRD_URL=${LLMDBENCH_FMA_LAUNCHER_POPULATOR_POLICIES_CRD_URL:-"https://raw.githubusercontent.com/llm-d-incubation/llm-d-fast-model-actuation/main/config/crd/fma.llm-d.ai_launcherpopulationpolicies.yaml"}

# Fast Model Actuation Dual Pod Configuration
export LLMDBENCH_FMA_DUAL_POD_SLEEPER_LIMIT="${LLMDBENCH_FMA_DUAL_POD_SLEEPER_LIMIT:-2}"
export LLMDBENCH_FMA_DUAL_POD_DEBUG_ACCELERATOR_MEMORY="${LLMDBENCH_FMA_DUAL_POD_DEBUG_ACCELERATOR_MEMORY:-false}"

# Fast Model Actuation Launcher Configuration
export LLMDBENCH_FMA_LAUNCHER_CONFIG_PORT="${LLMDBENCH_FMA_LAUNCHER_CONFIG_PORT:-8001}"

# Fast Model Actuation Launcher Populator Configuration
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_LIMITS_CPU="${LLMDBENCH_FMA_LAUNCHER_POPULATOR_LIMITS_CPU:-2}"
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_LIMITS_MEMORY="${LLMDBENCH_FMA_LAUNCHER_POPULATOR_LIMITS_MEMORY:-2Gi}"
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_REQUESTS_CPU="${LLMDBENCH_FMA_LAUNCHER_POPULATOR_REQUESTS_CPU:-100m}"
export LLMDBENCH_FMA_LAUNCHER_POPULATOR_REQUESTS_MEMORY="${LLMDBENCH_FMA_LAUNCHER_POPULATOR_REQUESTS_MEMORY:-128Mi}"

# Fast Model Actuation Requester Configuration
export LLMDBENCH_FMA_REQUESTER_IMAGE_REPOSITORY="${LLMDBENCH_FMA_REQUESTER_IMAGE_REPOSITORY:-ghcr.io/llm-d-incubation/llm-d-fast-model-actuation/requester}"
export LLMDBENCH_FMA_REQUESTER_IMAGE_TAG="${LLMDBENCH_FMA_REQUESTER_IMAGE_TAG:-v0.5.1-alpha.5}"
export LLMDBENCH_FMA_LAUNCHER_IMAGE_REPOSITORY="${LLMDBENCH_FMA_LAUNCHER_IMAGE_REPOSITORY:-ghcr.io/llm-d-incubation/llm-d-fast-model-actuation/launcher}"
export LLMDBENCH_FMA_LAUNCHER_IMAGE_TAG="${LLMDBENCH_FMA_LAUNCHER_IMAGE_TAG:-v0.5.1-alpha.5}"
export LLMDBENCH_FMA_REQUESTER_PROBE_PORT="${LLMDBENCH_FMA_REQUESTER_PROBE_PORT:-8080}"
export LLMDBENCH_FMA_REQUESTER_SPI_PORT="${LLMDBENCH_FMA_REQUESTER_SPI_PORT:-8081}"
export LLMDBENCH_FMA_REQUESTER_READINESS_PROBE_INITIAL_DELAY="${LLMDBENCH_FMA_REQUESTER_READINESS_PROBE_INITIAL_DELAY:-5}"
export LLMDBENCH_FMA_REQUESTER_READINESS_PROBE_PERIOD="${LLMDBENCH_FMA_REQUESTER_READINESS_PROBE_PERIOD:-10}"
export LLMDBENCH_FMA_REQUESTER_LIMITS_GPU="${LLMDBENCH_FMA_REQUESTER_LIMITS_GPU:-1}"
export LLMDBENCH_FMA_REQUESTER_LIMITS_CPU="${LLMDBENCH_FMA_REQUESTER_LIMITS_CPU:-1}"
export LLMDBENCH_FMA_REQUESTER_LIMITS_MEMORY="${LLMDBENCH_FMA_REQUESTER_LIMITS_MEMORY:-250Mi}"
...
export LLMDBENCH_VLLM_COMMON_PRIORITY_CLASS_NAME="${LLMDBENCH_VLLM_COMMON_PRIORITY_CLASS_NAME:-none}"
export LLMDBENCH_VLLM_COMMON_PULL_SECRET=${LLMDBENCH_VLLM_COMMON_PULL_SECRET:-}
export LLMDBENCH_VLLM_COMMON_CONTEXT_SECRET_NAME=${LLMDBENCH_VLLM_COMMON_CONTEXT_SECRET_NAME:-"llmdbench-context"}
...
export LLMDBENCH_VLLM_MONITORING_PODMONITOR_ENABLED=${LLMDBENCH_VLLM_MONITORING_PODMONITOR_ENABLED:-true}
...
export LLMDBENCH_VLLM_COMMON_EXTRA_INIT_CONTAINER_CONFIG=${LLMDBENCH_VLLM_COMMON_EXTRA_INIT_CONTAINER_CONFIG:-"{}"}
...
export LLMDBENCH_VLLM_STANDALONE_PREPROCESS=${LLMDBENCH_VLLM_STANDALONE_PREPROCESS:-${LLMDBENCH_VLLM_COMMON_PREPROCESS}}
...
export LLMDBENCH_VLLM_INFRA_GATEWAY_CPU_REQUEST=${LLMDBENCH_VLLM_INFRA_GATEWAY_CPU_REQUEST:-"4"}
export LLMDBENCH_VLLM_INFRA_GATEWAY_CPU_LIMIT=${LLMDBENCH_VLLM_INFRA_GATEWAY_CPU_LIMIT:-"16"}
export LLMDBENCH_VLLM_INFRA_GATEWAY_MEMORY_REQUEST=${LLMDBENCH_VLLM_INFRA_GATEWAY_MEMORY_REQUEST:-"4Gi"}
export LLMDBENCH_VLLM_INFRA_GATEWAY_MEMORY_LIMIT=${LLMDBENCH_VLLM_INFRA_GATEWAY_MEMORY_LIMIT:-"16Gi"}
...
export LLMDBENCH_VLLM_MODELSERVICE_GAIE_SIDECAR_ENABLED=${LLMDBENCH_VLLM_MODELSERVICE_GAIE_SIDECAR_ENABLED:-"False"}
export LLMDBENCH_VLLM_MODELSERVICE_GAIE_EPP_VERBOSITY=${LLMDBENCH_VLLM_MODELSERVICE_GAIE_EPP_VERBOSITY:-"1"}
export LLMDBENCH_VLLM_MODELSERVICE_GAIE_MONITORING_PROMETHEUS_ENABLED=${LLMDBENCH_VLLM_MODELSERVICE_GAIE_MONITORING_PROMETHEUS_ENABLED:-"true"}
...
export LLMDBENCH_HARNESS_INFERENCE_PERF_RAYON_NUM_THREADS=${LLMDBENCH_HARNESS_INFERENCE_PERF_RAYON_NUM_THREADS:-4}
...
export LLMDBENCH_CONTROL_FMA_RESOURCE_LIST=${LLMDBENCH_CONTROL_FMA_RESOURCE_LIST:-ReplicaSet,InferenceServerConfig,LauncherConfig,LauncherPopulationPolicy}
...
export LLMDBENCH_CONTROL_STEP_11_IMPLEMENTATION=${LLMDBENCH_CONTROL_STEP_11_IMPLEMENTATION:-py}
...
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_PREPROCESS=${LLMDBENCH_VLLM_MODELSERVICE_DECODE_PREPROCESS:-$LLMDBENCH_VLLM_COMMON_PREPROCESS}
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_MODEL_COMMAND=${LLMDBENCH_VLLM_MODELSERVICE_DECODE_MODEL_COMMAND:-vllmServe}
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_EXTRA_ARGS=${LLMDBENCH_VLLM_MODELSERVICE_DECODE_EXTRA_ARGS:-"[--no-enable-log-requests____--max-model-len____REPLACE_ENV_LLMDBENCH_VLLM_COMMON_MAX_MODEL_LEN____--tensor-parallel-size____REPLACE_ENV_LLMDBENCH_VLLM_MODELSERVICE_DECODE_TENSOR_PARALLELISM]"}
...
export LLMDBENCH_VLLM_MODELSERVICE_DECODE_INIT_CONTAINER_CONFIG=${LLMDBENCH_VLLM_MODELSERVICE_DECODE_INIT_CONTAINER_CONFIG:-$LLMDBENCH_VLLM_COMMON_EXTRA_INIT_CONTAINER_CONFIG}
...
export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_EXTRA_ARGS=${LLMDBENCH_VLLM_MODELSERVICE_PREFILL_EXTRA_ARGS:-"[--no-enable-log-requests____--max-model-len____REPLACE_ENV_LLMDBENCH_VLLM_COMMON_MAX_MODEL_LEN____--tensor-parallel-size____REPLACE_ENV_LLMDBENCH_VLLM_MODELSERVICE_PREFILL_TENSOR_PARALLELISM]"}
...
export LLMDBENCH_VLLM_MODELSERVICE_PREFILL_INIT_CONTAINER_CONFIG=${LLMDBENCH_VLLM_MODELSERVICE_PREFILL_INIT_CONTAINER_CONFIG:-$LLMDBENCH_VLLM_COMMON_EXTRA_INIT_CONTAINER_CONFIG}
...
if [[ ! -z $LLMDBENCH_DEPLOY_SCENARIO ]]; then
  ...
  if [[ "$LLMDBENCH_DEPLOY_SCENARIO" == /* ]]; then
    ...
    export LLMDBENCH_SCENARIO_FULL_PATH=$(find "${LLMDBENCH_MAIN_DIR}/scenarios" -name "$LLMDBENCH_DEPLOY_SCENARIO.sh")
...
case $LLMDBENCH_DEPLOY_METHODS in
  "standalone")
    ...
    export LLMDBENCH_CONTROL_ENVIRONMENT_TYPE_FMA_ACTIVE=0
    ;;
  "modelservice")
  ...
  "fma")
    export LLMDBENCH_CONTROL_ENVIRONMENT_TYPE_STANDALONE_ACTIVE=0
    export LLMDBENCH_CONTROL_ENVIRONMENT_TYPE_MODELSERVICE_ACTIVE=0
    export LLMDBENCH_CONTROL_ENVIRONMENT_TYPE_FMA_ACTIVE=1
    ;;
