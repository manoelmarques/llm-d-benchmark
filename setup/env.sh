...
export LLMDBENCH_VLLM_MODELSERVICE_CHART_VERSION=${LLMDBENCH_VLLM_MODELSERVICE_CHART_VERSION:-"v0.4.7"}
export LLMDBENCH_IMAGE_TAG=${LLMDBENCH_IMAGE_TAG:-auto}
export LLMDBENCH_LLMD_IMAGE_TAG=${LLMDBENCH_LLMD_IMAGE_TAG:-"v0.5.1"}
export LLMDBENCH_LLMD_INFERENCESCHEDULER_IMAGE_TAG=${LLMDBENCH_LLMD_INFERENCESCHEDULER_IMAGE_TAG:-"v0.6.0"}
export LLMDBENCH_LLMD_ROUTINGSIDECAR_IMAGE_TAG=${LLMDBENCH_LLMD_ROUTINGSIDECAR_IMAGE_TAG:-"v0.6.0"}
export LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_TAG=${LLMDBENCH_LLMD_UDS_TOKENIZER_IMAGE_TAG:-"v0.6.0"}
export LLMDBENCH_VLLM_STANDALONE_IMAGE_TAG=${LLMDBENCH_VLLM_STANDALONE_IMAGE_TAG:-"v0.9.2"}
...
export LLMDBENCH_WVA_CHART_VERSION="${LLMDBENCH_WVA_CHART_VERSION:-0.5.1}"
export LLMDBENCH_WVA_IMAGE_TAG="${LLMDBENCH_WVA_IMAGE_TAG:-v0.5.1}"
