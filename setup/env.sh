...
export LLMDBENCH_WVA_CHART_VERSION="${LLMDBENCH_WVA_CHART_VERSION:-0.4.1}"
...
export LLMDBENCH_WVA_IMAGE_TAG="${LLMDBENCH_WVA_IMAGE_TAG:-v0.4.1}"
...
export LLMDBENCH_VLLM_COMMON_ENVVARS_TO_YAML=${LLMDBENCH_VLLM_COMMON_ENVVARS_TO_YAML:-LLMDBENCH_VLLM_COMMON_VLLM_WORKER_MULTIPROC_METHOD,LLMDBENCH_VLLM_COMMON_VLLM_LOGGING_LEVEL,LLMDBENCH_VLLM_COMMON_VLLM_CACHE_ROOT,LLMDBENCH_VLLM_COMMON_VLLM_ALLOW_LONG_MAX_MODEL_LEN,LLMDBENCH_VLLM_COMMON_VLLM_SERVER_DEV_MODE}
...
export LLMDBENCH_VLLM_INFRA_CHART_VERSION=${LLMDBENCH_VLLM_INFRA_CHART_VERSION:-v1.3.4}
