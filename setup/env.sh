...
# FMA Fast Model Actuation Dual Pod
export LLMDBENCH_FMA_ENABLED="${LLMDBENCH_FMA_ENABLED:-false}"
export LLMDBENCH_FMA_HELM_REPOSITORY_URL=${LLMDBENCH_FMA_HELM_REPOSITORY_URL:-"oci://ghcr.io/manoelmarques/llm-d-fast-model-actuation/charts/dual-pods-controller"}
export LLMDBENCH_FMA_CHART_VERSION="${LLMDBENCH_FMA_CHART_VERSION:-0.1.0}"

# FMA Configuration
export LLMDBENCH_FMA_IMAGE_REPOSITORY="${LLMDBENCH_FMA_IMAGE_REPOSITORY:-ghcr.io/llm-d-incubation/llm-d-fast-model-actuation-controller}"
export LLMDBENCH_FMA_IMAGE_TAG="${LLMDBENCH_FMA_IMAGE_TAG:-latest}"
export LLMDBENCH_FMA_CLUSTER_ROLE="${LLMDBENCH_FMA_CLUSTER_ROLE:-}"
export LLMDBENCH_FMA_SLEEPER_LIMIT="${LLMDBENCH_FMA_SLEEPER_LIMIT:-2}"
export LLMDBENCH_FMA_DEBUG_ACCELERATOR_MEMORY="${LLMDBENCH_FMA_DEBUG_ACCELERATOR_MEMORY:-false}"

# FMA Requester Configuration
