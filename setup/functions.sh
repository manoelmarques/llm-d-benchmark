...
spec:
  ...
  - name: harness
    ...
    - name: LLMDBENCH_HARNESS_STACK_ENDPOINT_LAUNCHER_URL
      value: "${LLMDBENCH_HARNESS_STACK_ENDPOINT_LAUNCHER_URL}"
    - name: LLMDBENCH_HARNESS_STACK_ENDPOINT_LAUNCHER_VLLM_URL
      value: "${LLMDBENCH_HARNESS_STACK_ENDPOINT_LAUNCHER_VLLM_URL}"
